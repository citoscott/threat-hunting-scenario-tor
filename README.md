[tor-download.csv](https://github.com/user-attachments/files/19523684/tor-download.csv)# threat-hunting-scenario-tor
...
Searched for any `ProcessCommandLine` that contained the string "C:\Users\labuser\Downloads\tor-browser-windows-x86_64-portable-14.0.8.exe". Based on the logs returned, at `2025-03-29T19:08:50.222997Z`, an employee on the "woohoo" device ran the file `tor-browser-windows-x86_64-portable-14.0.8.exe` from their Downloads folder, using a command that triggered a silent installation.
